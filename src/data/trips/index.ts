...
export const allTrips: Trip[] = [
  ...
  },
  {
    ...
    description: 'Explore 7 capítulos inspiradores com diálogos e vocabulário contextual focado no aprendizado prático da Grande Comissão.',
    category: 'faith',
    badgeText: '7 Livros • Vocabulário Prático',
    iconName: 'Compass',
