...
export const initialPodcastEpisodes: PodcastEpisodeData[] = [
  {
    ...
    description: 'Neste episódio de estreia do Podcast Antigravity, acompanhamos os primeiros passos de Paul no aprendizado de inglês do zero ao nível intermediário (B1). Descubra como funciona a assimilação natural do vocabulário essencial de 2.000 palavras mais usadas e como usar a imersão diária a seu favor.',
    audioUrl: '/podcasts/episodio-01.mp3',
    duration: '20:00',
    publishedAt: '2026-08-29',
    host: 'Paul Ortiz & Equipe Antigravity',
