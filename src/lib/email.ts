...
export async function sendPasswordResetEmail(email: string, token: string) {
  ...
  const html = [
    ...
    '<style>',
    'body{font-family:"Outfit",-apple-system,sans-serif;background:#f1f5f9;color:#1e293b;margin:0;padding:20px}',
    '.container{max-width:560px;margin:0 auto;background:#fff;border-radius:20px;padding:30px;box-shadow:0 10px 30px rgba(0,0,0,.08)}',
    ...
    '.btn{background:#4a90e2;color:#fff!important;padding:14px 28px;border-radius:12px;font-weight:700;text-decoration:none;display:inline-block;box-shadow:0 4px 12px rgba(74,144,226,.35)}',
    '.footer{text-align:center;font-size:12px;color:#94a3b8;margin-top:30px;border-top:1px solid #f1f5f9;padding-top:15px}',
    '</style></head><body>',
    '<div class="container">',
    '<div class="header">',
    '<h1 class="title">Paul Ortiz \u2014 Mountain Learning</h1>',
    '<p class="subtitle">Plataforma de Aprendizado &amp; Escalada da Montanha</p>',
    '</div>',
    '<div class="content">',
    '<p>Ol\u00e1,</p>',
    '<p>Recebemos uma solicita\u00e7\u00e3o para redefinir a senha da sua conta na plataforma <strong>Paul Ortiz \u2014 Mountain Learning</strong>.</p>',
    ...
    '</div>',
    '<div class="footer">\u00a9 ' + year + ' Paul Ortiz \u2014 Mountain Learning. Todos os direitos reservados.</div>',
    '</div></body></html>',
  ].join('\n');
...
export async function sendWelcomeEmail(email: string, name: string, role: string) {
  ...
  const html = [
    ...
    '<div class="container">',
    '<div class="header">',
    '<h1 class="title">Bem-vindo(a) ao Mountain Learning! \ud83c\udfd4\ufe0f</h1>',
    '<p class="subtitle">Sua Jornada de Aprendizado de Ingl\u00eas Come\u00e7ou</p>',
    '</div>',
    '<div class="content">',
    '<p>Ol\u00e1 <strong>' + name + '</strong>,</p>',
    '<p>Sua conta foi criada com sucesso na plataforma <strong>Paul Ortiz \u2014 Mountain Learning</strong>!</p>',
